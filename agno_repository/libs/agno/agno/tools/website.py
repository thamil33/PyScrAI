...
from agno_src.knowledge.combined import CombinedKnowledgeBase
from agno_src.knowledge.website import WebsiteKnowledgeBase
...
class WebsiteTools(Toolkit):
    ...
    def read_url(self, url: str) -> str:
        ...
        """
        from agno_src.document.reader.website_reader import WebsiteReader
