...
from agno_src.exceptions import ModelProviderError, RunCancelledException
...
from agno_src.memory.team import TeamMemory, TeamRun
...
from agno_src.utils.response import (
...
from agno_src.utils.string import is_valid_uuid, parse_response_model_str, url_safe_string
...
class Team:
    ...
    def _print_response(
        ...
        **kwargs: Any,
        ...
        from agno_src.utils.response import format_tool_calls
            ...
            if isinstance(self.memory, TeamMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from agno_src.memory.memory import Memory as UserMemoryV1
                ...
                if "team_context" in session.memory:
                    from agno_src.memory.v2.memory import TeamContext
    ...
    def _log_team_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from agno_src.api.team import TeamRunCreate, create_team_run
    ...
    async def _alog_team_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from agno_src.api.team import TeamRunCreate, acreate_team_run
    ...
    def _log_team_session(self, session_id: str, user_id: Optional[str] = None):
        ...
        from agno_src.api.team import TeamSessionCreate, upsert_team_session
