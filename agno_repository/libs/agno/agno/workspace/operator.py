...
from agno_src.api.schemas.user import TeamIdentifier, TeamSchema
from agno_src.api.schemas.workspace import (
    WorkspaceCreate,
    WorkspaceEvent,
    WorkspaceSchema,
    WorkspaceUpdate,
)
from agno_src.api.workspace import log_workspace_event
from agno_src.cli.config import AgnoCliConfig
from agno_src.cli.console import (
    console,
...
from agno_src.infra.resources import InfraResources
from agno_src.utils.common import str_to_int
from agno_src.utils.log import logger
from agno_src.workspace.config import WorkspaceConfig
from agno_src.workspace.enums import WorkspaceStarterTemplate
...
def create_workspace(
    ...
    from agno_src.cli.operator import initialize_agno
    from agno_src.utils.filesystem import rmdir_recursive
    from agno_src.utils.git import GitCloneProgress
    from agno_src.workspace.helpers import get_workspace_dir_path
...
def setup_workspace(ws_root_path: Path) -> Optional[WorkspaceConfig]:
    ...
    from agno_src.cli.operator import initialize_agno
    from agno_src.utils.git import get_remote_origin_for_dir
    from agno_src.workspace.helpers import get_workspace_dir_path
    ...
    if agno_config.user is None:
        from agno_src.api.user import create_anon_user
    ...
    if agno_config.user is not None:
        ...
        if ws_schema is None or ws_schema.id_workspace is None:
            from agno_src.api.workspace import create_workspace_for_user, get_teams_for_user
        ...
        if git_remote_origin_url is not None and ws_schema is not None and ws_schema.git_url != git_remote_origin_url:
            from agno_src.api.workspace import update_workspace_for_team, update_workspace_for_user
