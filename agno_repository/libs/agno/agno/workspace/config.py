...
from agno_src.api.schemas.user import TeamSchema
from agno_src.api.schemas.workspace import WorkspaceSchema
from agno_src.infra.base import InfraBase
from agno_src.infra.resources import InfraResources
from agno_src.utils.log import logger
from agno_src.workspace.settings import WorkspaceSettings
...
class WorkspaceConfig(BaseModel):
    ...
    def workspace_settings(self) -> Optional[WorkspaceSettings]:
        ...
        try:
            from agno_src.utils.py_io import get_python_objects_from_module
    ...
    def set_local_env(self) -> None:
        ...
        from agno_src.constants import (
            AWS_REGION_ENV_VAR,
