...
from agno_src.agent.metrics import SessionMetrics
from agno_src.exceptions import ModelProviderError, StopAgentRun
from agno_src.knowledge.agent import AgentKnowledge
from agno_src.media import Audio, AudioArtifact, AudioResponse, File, Image, ImageArtifact, Video, VideoArtifact
from agno_src.memory.agent import AgentMemory, AgentRun
from agno_src.memory.v2.memory import Memory, SessionSummary
from agno_src.models.base import Model
from agno_src.models.message import Citations, Message, MessageMetrics, MessageReferences
from agno_src.models.response import ModelResponse, ModelResponseEvent, ToolExecution
from agno_src.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
...
from agno_src.utils.log import (
    log_debug,
    log_error,
    log_exception,
    log_info,
...
from agno_src.utils.message import get_text_from_message
from agno_src.utils.prompts import get_json_output_prompt
from agno_src.utils.response import create_panel, escape_markdown_tags, format_tool_calls
from agno_src.utils.safe_formatter import SafeFormatter
...
class Agent:
    ...
    def load_agent_session(self, session: AgentSession):
        ...
        from agno_src.utils.merge_dict import merge_dictionaries
            ...
            if isinstance(self.memory, AgentMemory):
                try:
                    ...
                    if "memories" in session.memory:
                        from agno_src.memory.memory import Memory as UserMemory
                ...
                if "runs" in session.memory:
                    try:
                        ...
                        log_warning(f"Failed to load runs from memory: {e}")
                if "memories" in session.memory:
                    from agno_src.memory.v2.memory import UserMemory as UserMemoryV2
                ...
                if "summaries" in session.memory:
                    from agno_src.memory.v2.memory import SessionSummary as SessionSummaryV2
    ...
    def reason(self, run_messages: RunMessages, session_id: Optional[str] = None) -> Iterator[RunResponse]:
        ...
        if reasoning_model_provided:
            from agno_src.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
            from agno_src.reasoning.deepseek import is_deepseek_reasoning_model
            from agno_src.reasoning.groq import is_groq_reasoning_model
            from agno_src.reasoning.helpers import get_reasoning_agent
            from agno_src.reasoning.ollama import is_ollama_reasoning_model
            from agno_src.reasoning.openai import is_openai_reasoning_model
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                ...
                if is_deepseek:
                    from agno_src.reasoning.deepseek import get_deepseek_reasoning
                    ...
                    from agno_src.reasoning.groq import get_groq_reasoning
                    ...
                    from agno_src.reasoning.openai import get_openai_reasoning
                    ...
                    from agno_src.reasoning.ollama import get_ollama_reasoning
                    ...
                    from agno_src.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
        ...
        if use_default_reasoning:
            from agno_src.reasoning.default import get_default_reasoning_agent
            from agno_src.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    async def areason(self, run_messages: RunMessages, session_id: Optional[str] = None) -> Any:
        ...
        if reasoning_model_provided:
            ...
            if is_deepseek or is_groq or is_openai or is_ollama or is_ai_foundry:
                reasoning_message: Optional[Message] = None
                if is_deepseek:
                    from agno_src.reasoning.deepseek import aget_deepseek_reasoning
                    ...
                    from agno_src.reasoning.groq import aget_groq_reasoning
                    ...
                    from agno_src.reasoning.openai import aget_openai_reasoning
    ...
    def _log_agent_session(self, session_id: str, user_id: Optional[str] = None):
        ...
        from agno_src.api.agent import AgentSessionCreate, create_agent_session
    ...
    def _log_agent_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from agno_src.api.agent import AgentRunCreate, create_agent_run
    ...
    async def _alog_agent_run(self, session_id: str, user_id: Optional[str] = None) -> None:
        ...
        from agno_src.api.agent import AgentRunCreate, acreate_agent_run
    ...
    def _add_reasoning_step_to_extra_data(self, reasoning_step: ReasoningStep) -> None:
        if hasattr(self, "run_response") and self.run_response is not None:
            if self.run_response.extra_data is None:
                from agno_src.run.response import RunResponseExtraData
