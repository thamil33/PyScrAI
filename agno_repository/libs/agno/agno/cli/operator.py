...
from agno_src.cli.console import print_heading, print_info
from agno_src.cli.settings import AGNO_CLI_CONFIG_DIR, agno_cli_settings
from agno_src.infra.resources import InfraResources
from agno_src.utils.log import logger


def delete_agno_config() -> None:
    from agno_src.utils.filesystem import delete_from_fs
...
def authenticate_user() -> None:
    ...
    """
    from agno_src.api.schemas.user import UserSchema
    from agno_src.api.user import authenticate_and_get_user
    from agno_src.cli.auth_server import (
        get_auth_token_from_web_flow,
        get_port_for_auth_server,
    )
    from agno_src.cli.credentials import save_auth_token
