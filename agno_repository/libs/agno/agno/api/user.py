...
from agno_src.api.api import api, invalid_response
from agno_src.api.routes import ApiRoutes
from agno_src.api.schemas.user import EmailPasswordAuthSchema, UserSchema
from agno_src.cli.config import AgnoCliConfig
from agno_src.cli.settings import agno_cli_settings
...
def authenticate_and_get_user(auth_token: str, existing_user: Optional[UserSchema] = None) -> Optional[UserSchema]:
    ...
    from agno_src.cli.credentials import read_auth_token
