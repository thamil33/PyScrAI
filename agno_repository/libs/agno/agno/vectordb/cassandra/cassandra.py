...
from agno_src.embedder import Embedder
from agno_src.utils.log import log_debug, log_info
from agno_src.vectordb.base import VectorDb
from agno_src.vectordb.cassandra.index import AgnoMetadataVectorCassandraTable
...
class Cassandra(VectorDb):
    def __init__(
        ...
        if embedder is None:
            from agno_src.embedder.openai import OpenAIEmbedder
